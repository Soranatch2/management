...
explore: jira_dataset_daily {
  label: "Master_Project"
  view_name: jira_dataset_daily
  view_label: "Jira"
  ...
  join: everhour_dataset {
    ...
    sql_on: ${jira_dataset_daily.scope_id} = trim(${everhour_dataset.scope_id}) ;;
  }
  ...
  join: everhour_time_tracking {
    ...
    sql_on: ${jira_dataset_daily.scope_id} = trim(${everhour_time_tracking.scope_id}) ;;
  }
  ...
  join: project_plan {
    ...
    view_label: "Project"
    relationship: one_to_one
    sql_on: ${jira_dataset_daily.scope_id} = ${project_plan.scope_id} ;;
  }
